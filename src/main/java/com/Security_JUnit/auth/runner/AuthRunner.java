...
import com.Security_JUnit.auth.configuration.UserConfiguration;
...
public class AuthRunner implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		userConfiguration.fakeUser();

		RegisterDto r1 = new RegisterDto();
		r1.setName("Vittorio");
		r1.setUsername("FrancoV");
		r1.setEmail("f.v@mail.com");
		r1.setPassword("Vittorio");
		// r1.setRoles();
